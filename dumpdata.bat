...
py manage.py dumpdata --format json --indent 4 -o .fixtures/0005_admin.json admin
py manage.py dumpdata --format json --indent 4 -o .fixtures/0004_auth.json auth
py manage.py dumpdata --format json --indent 4 -o .fixtures/0003_contenttypes.json contenttypes
